...
LRESULT CALLBACK WndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
    ...
    case WM_COMMAND:
        {
            ...
            case IDM_EXIT:
                ...
                break;
            case IDM_NEW:
                DialogBox(hInst, MAKEINTRESOURCE(IDD_UNDERDEVELOPMENBOX), hWnd, About);
                break;
			case BN_CLICKED:
				switch (LOWORD(wParam))
				{
					case BTN_BUTTON1: // or whatever the ID of your button is...
					{
						DialogBox(hInst, MAKEINTRESOURCE(IDD_ABOUTBOX), hWnd, About);
					break;
					}
	...
	{ 
		...
		HWND hwndButton = CreateWindowEx(0, L"BUTTON", L"Botó", WS_TABSTOP | WS_VISIBLE | WS_CHILD | BS_DEFPUSHBUTTON, 125, 15, 80, 30, hWnd, (HMENU)BTN_BUTTON1, hIns, NULL);
		return 0;
	}
    case WM_PAINT:
        {
